...
const ChatSettingsForm: React.FC<ChatSettingsFormProps> = ({
  ...
  return (
    <div className="mx-auto w-full pt-3 md:max-w-2xl lg:max-w-3xl xl:max-w-4xl">
      <form
        onSubmit={handleSubmit}
        className="mb-4 bg-white px-8 pb-8 pt-6 dark:bg-gray-800"
      >
        <AvatarFieldEditor
          readOnly={readOnly}
          image={
        ...
        <div className="mb-4">
          ...
          {readOnly ? (
            ...
            <textarea
              ...
              name="instructions"
              onChange={handleInputChange}
              className="focus:shadow-outline h-56 max-h-[60vh] w-full resize-y appearance-none overflow-y-auto rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 md:max-h-[calc(100vh-300px)]"
            ></textarea>
          )}
        </div>
        <div className="mb-4">
