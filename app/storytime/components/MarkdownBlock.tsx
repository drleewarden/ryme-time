...
const MarkdownBlock: React.FC<ChatBlockProps> = ({
  ...
  function codeBlock({ node, className, children, ...props }: any) {
    ...
    return isInline ? (
      ...
      <div className="codeBlockContainer dark:bg-gray-850 rounded-md border border-gray-200 dark:border-gray-800">
        <div className="dark:bg-gray-850 relative flex items-center justify-between rounded-t-md bg-gray-200 px-4 py-1.5 font-sans text-xs text-gray-900 dark:text-gray-200">
          <span>{language}</span>
