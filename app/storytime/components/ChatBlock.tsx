      ...
      className={`group w-full border-b border-black/10 text-gray-800 dark:border-gray-900/50 dark:text-gray-100
            ${
              block.role === 'assistant'
                ...
                : 'dark:bg-gray-850 bg-white'
            }`}
    >
      <div className="3xl:max-w-6xl 4xl:max-w7xl m-auto flex flex-col p-2 text-base md:max-w-2xl lg:max-w-3xl lg:px-0 xl:max-w-4xl 2xl:max-w-5xl">
        <div className="flex w-full">
          <div className="relative mr-4 flex w-[30px] flex-col items-end">
            <div className="relative flex h-[30px] w-[30px] items-center justify-center rounded-sm p-0">
              {block.role === 'user' ? (
          ...
          <div className="relative flex w-[calc(100%-50px)] flex-col gap-1 md:gap-3 lg:w-full">
            <div
              ...
              style={errorStyles}
            >
              <div className="flex min-h-[20px] flex-col items-start gap-4">
                {isEdit ? (
                  <textarea
                    spellCheck={false}
                    tabIndex={0}
                    ...
                    className="m-0 w-full resize-none border border-black/10 bg-transparent bg-white p-0 pl-2 pr-7 shadow-none outline-none focus:ring-0 focus-visible:ring-0  dark:border-gray-900/50 dark:bg-gray-700 dark:bg-transparent md:pl-0"
        ...
        {!(isLastBlock && loading) && (
          <div
            ...
            className="ml-10 flex items-center justify-start"
          >
            {block.role === 'assistant' && (
