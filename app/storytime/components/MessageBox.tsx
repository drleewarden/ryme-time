  ...
  ({ loading, setLoading, callApp, allowImageAttachment }, ref) => {
    ...
    return (
      <div
        ...
        className="absolute bottom-0 left-0 w-full border-t bg-white pt-2 dark:border-white/20 dark:bg-gray-900 md:border-t-0 md:border-transparent md:!bg-transparent md:dark:border-transparent"
      >
        <form
          onSubmit={handleSubmit}
          className="stretch 3xl:max-w-6xl 4xl:max-w7xl mx-2 flex flex-row gap-3 last:mb-2 md:mx-4 md:max-w-2xl md:last:mb-6 lg:mx-auto lg:max-w-3xl xl:max-w-4xl 2xl:max-w-5xl"
        >
          <div
            id="message-box-border"
            style={{ borderRadius: '1rem' }}
            className="dark:bg-gray-850 dark:bg-gray-850 relative flex h-full w-full flex-1 flex-grow flex-col border border-black/10
               bg-white py-2 focus-within:border-black/30 dark:border-gray-900/50 dark:text-white
               dark:focus-within:border-gray-500/50 md:py-3"
          >
            ...
            <div className="relative flex w-full items-center space-x-2">
              ...
              <textarea
                ...
                ref={textAreaRef}
                rows={1}
                className="m-0 flex-auto resize-none border-0 bg-transparent px-2 py-2 shadow-none outline-none focus:ring-0 focus-visible:ring-0 dark:bg-transparent"
