...
const MainPage: React.FC<MainPageProps> = ({
  ...
  return (
    <div
      className={`${className} relative z-0 flex h-full w-full overflow-hidden dark:bg-gray-900`}
    >
      <div className="flex h-full w-full flex-col items-stretch">
        <main
          className="transition-width relative flex h-full flex-1 flex-col items-stretch overflow-hidden"
          onMouseUp={handleMouseUp}
        >
          {gid ? (
            <div
              className={`absolute left-0 top-0 z-50 inline-block ${
                isSidebarCollapsed
          ...
          {showScrollButton && (
            <div className="absolute bottom-0 left-1/2 z-10 mb-10 -translate-x-1/2 transform">
