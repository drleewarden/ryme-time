...
const ChatSettingDropdownMenu: React.FC<ChatSettingDropdownMenuProps> = ({
  ...
  } w-56 mt-2 origin-top-left bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 divide-y divide-gray-100 dark:divide-gray-600 rounded-md shadow-lg outline-none z-20`;
          ...
          {({ open }) => (
            <>
              <Menu.Button
                ...
                className="text-md inline-flex items-center rounded-md bg-white px-3 font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
              >
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            >
              ...
              >
                <Dialog.Panel className="relative w-full max-w-2xl overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-gray-800">
