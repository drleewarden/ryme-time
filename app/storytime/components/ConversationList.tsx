  ...
  return (
    <div className="conversation-list-container">
      ...
      >
        <input
          id="searchInput"
          className="dark:bg-gray-850 flex-grow rounded-md border px-2 py-1 dark:border-white/20 dark:text-gray-100"
          type="text"
          autoComplete="off"
        ...
        />
        <button
          className="ml-2 rounded-md border p-1 dark:border-white/20"
          onClick={() => {
            handleSearch(searchInputValue);
            setShowSearchOptions(false);
          }}
      ...
      >
        <div className="flex flex-col gap-2 pb-2 text-sm text-gray-800 dark:text-gray-100">
          <div
                ...
                if ('marker' in convo) {
                  return (
                    <li key={`marker-${index}`} className="sticky top-0 z-[16]">
                      <h3 className="h-9 overflow-hidden text-ellipsis bg-gray-50 px-3 pb-2 pt-3 text-xs font-medium text-gray-500 dark:bg-gray-900">
                        {convo.title}
                      </h3>
                    </li>
                  );
